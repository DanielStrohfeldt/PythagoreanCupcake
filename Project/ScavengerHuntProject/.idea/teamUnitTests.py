...
class TeamUnitTests(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(None, self.team1.endTime, "team1's endTime should be None upon initialization")
    ...
    def test_endTime(self):
        ...
        self.assertEqual(None, self.team1.endTime, "team1's end time should be None upon initialization")
        self.team1.end_time()
        self.assertNotEqual(None, self.team1.endTime, "team1's end time should not be None upon initialization")
    ...
    def test_getEndTime(self):
        self.assertEqual(None, self.team1.get_endtime(), "get_endtime() should return None but returned "
                         + str(self.team1.get_endtime()))
        self.team1.endTime = 20
        self.assertEqual(20, self.team1.get_endtime(), "get_endtime() should return 20 but returned "
                         + str(self.team1.get_endtime()))
        self.team1.endTime = 40
        self.assertEqual(40, self.team1.get_endtime(), "get_endtime() should return 40 but returned "
                         + str(self.team1.get_endtime()))
        self.team1.endTime = 60
        self.assertEqual(60, self.team1.get_endtime(), "get_endtime() should return 60 but returned "
                         + str(self.team1.get_endtime()))
